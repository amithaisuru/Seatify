  ...
  const fetchUsers = async (e) =>{
    try {
      ...
      if (response.ok) {
        ...
        setToast({ show: true, type: 'success', message: 'Users fetched successfully!' });
      }
      else {
        if (data.error === "Token has expired!") {
            console.error('Token expired. Redirecting to login...');
            ...
            // Handle other errors
            setToast({ show: true, type: 'error', message: 'Failed to fetch users. Please try again.' });
    ...
    <div className="p-6 bg-gray-50 min-h-screen dark:bg-gray-900">
      <main className="grow">
        <div className="mb-4 sm:mb-0">
          <h1 className="mb-6 text-sm md:text-xl text-primary-light dark:text-primary-dark font-bold">User Profiles</h1>
        </div>
        <div>
          <div className="p-2">
        ...
        <div>
          <div className="p-2">
              <Table1 cafes={cafeUsers} tableTopic={'Cafe'} fetchUsers={fetchUsers}/>
          </div>
        </div>
  ...
  {/* <div className="relative flex flex-col flex-1 overflow-y-hidden bg-primary-lighter dark:bg-gray-800 rounded-md justify-center overflow-x-hidden font-poppins">
    <div className={` flex flex-1 flex-col px-6 py-6 lg:px-8`}>
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className=" text-center text-3xl leading-9 tracking-tight text-primary-darker dark:text-primary-lighter font-sans">
            Register users
        </h2>
      </div>
