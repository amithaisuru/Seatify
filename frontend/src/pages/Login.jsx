  ...
  return (
    <>
      <div className="flex flex-col md:flex-row min-h-screen bg-primary-lighter dark:bg-primary-darker overflow-hidden font-poppins">
        ...
        <div
          className="flex-1 flex flex-col justify-center items-center text-center p-10 bg-cover bg-center bg-no-repeat"
        ...
        >
          <div className="flex flex-col justify-center items-center inset-0 bg-black bg-opacity-50 z-0 w-full p-4 rounded-md">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-md">
              Find, Book, and Relax at your Favorite cafes and Lounges. Seamless
              Seat Reservation made simple.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm space-y-6">
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div>
                <label
                  htmlFor="email"
                  className="block text-md font-medium leading-6 text-gray-600 dark:text-gray-400"
                >
                  Email
                </label>
                <div className="mt-2">
                ...
                {messages.email && (
                  <p className="text-red-500 text-sm mt-2">{messages.email}</p>
                )}
              </div>
